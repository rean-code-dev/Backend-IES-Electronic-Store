...
import WebSocketChat from './connect_socket/channel_socketClient';
import { BrowserRouter as Router, Route, Routes, Link } from 'react-router-dom';
import ReceiverPage from './connect_socket/receiverPage';
import SenderPage from './connect_socket/senderPage';
function App() {
  return (
    <Router>
    <div>
